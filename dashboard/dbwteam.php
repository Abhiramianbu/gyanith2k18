<?php
    ...
    try{
        ...
        /*****************************TEAM1********************************* */
        /******************************************************************* */
        if(isset($_POST['submitwteam1'])){
            $etnm1=$_POST['etnm1'];
            //check existence of team name
            $stmt1=$db->prepare('select * from wkteam where tname=:tname');
            ...
            if($result==null){
                ...
                if(!empty($_POST['emem11'])){
                    if($result1['wtid1']==null){$val1=1;}
                    else if( $result1['wtid2']==null){$val1=2;}
                    else if( $result1['wtid3']==null){$val1=3;}
                    else if( $result1['wtid4']==null){$val1=4;}
                    else{
                        echo "f1 This member exceeded number of teams limit";exit();
                    }
                }
                if(!empty($_POST['emem12'])){
                    if($result2['wtid1']==null){$val2=1;}
                    else if( $result2['wtid2']==null){$val2=2;}
                    else if( $result2['wtid3']==null){$val2=3;}
                    else if( $result2['wtid4']==null){$val2=4;}
                    else{
                        echo "f2 This member exceeded number of teams limit";exit();
                    }
                }
                if(!empty($_POST['emem13'])){
                    if($result3['wtid1']==null){$val3=1;}
                    else if( $result3['wtid2']==null){$val3=2;}
                    else if( $result3['wtid3']==null){$val3=3;}
                    else if( $result3['wtid4']==null){$val3=4;}
                    else{
                        echo "f3 This member exceeded number of teams limit";exit();
                    }
                }
                if(!empty($_POST['emem14'])){
                    if($result4['wtid1']==null){$val4=1;}
                    else if( $result4['wtid2']==null){$val4=2;}
                    else if( $result4['wtid3']==null){$val4=3;}
                    else if( $result4['wtid4']==null){$val4=4;}
                    else{
                        echo "f4 This member exceeded number of teams limit";exit();
                    }
                }
                if(!empty($_POST['emem15'])){
                    if($result5['wtid1']==null){$val5=1;}
                    else if( $result5['wtid2']==null){$val5=2;}
                    else if( $result5['wtid3']==null){$val5=3;}
                    else if( $result5['wtid4']==null){$val5=4;}
                    else{
                        echo "f5 This member exceeded number of teams limit";exit();
                    }
                }
                if(!empty($_POST['emem16'])){
                    if($result6['wtid1']==null){$val6=1;}
                    else if( $result6['wtid2']==null){$val6=2;}
                    else if( $result6['wtid3']==null){$val6=3;}
                    else if( $result6['wtid4']==null){$val6=4;}
                    else{
                        echo "f6 This member exceeded number of teams limit";exit();
                    }
                }
                //inserting team name in eveteam table
                $stmt=$db->prepare('insert into wkteam (tname,gid) values (:tname,:gid)');
                $stmt->bindParam(':tname', $etnm1);
                $stmt->bindParam(':gid', $gid);
                $stmt->execute();
                $stmt2=$db->prepare('select tid from wkteam where tname=:tname and gid=:gid');
                ...
                if($creator==0){
                    ...
                    $result1=$stmt1->fetch();
                    if($result1['wtid1']==null){
                        $stmt=$db->prepare('update user set wtid1=:tid where gid=:gid');
                        $stmt->execute(array(':tid'=>$tid,':gid'=>$gid));
                    }
                    else if( $result1['wtid2']==null){
                        $stmt=$db->prepare('update user set wtid2=:tid where gid=:gid');
                        $stmt->execute(array(':tid'=>$tid,':gid'=>$gid));
                    }
                    else if( $result1['wtid3']==null){
                        $stmt=$db->prepare('update user set wtid3=:tid where gid=:gid');
                        $stmt->execute(array(':tid'=>$tid,':gid'=>$gid));
                    }
                    else if( $result1['wtid4']==null){
                        $stmt=$db->prepare('update user set wtid4=:tid where gid=:gid');
                        $stmt->execute(array(':tid'=>$tid,':gid'=>$gid));
                    }
                }
