...
<html lang="en">
	...
	<style type="text/css">
	    .s1{
	    	font-size: 0.3em; letter-spacing: 8px;padding-left: 27%;
	    }
	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="logo" class="parallax-front" style="font-family: 'Proxima Nova';"><span class="s1">NIT PUDUCHERRY</span></br><span style="font-size: 0.9em;">Gyanith'18</span></div>
			<br/>
						...
						<h3 style="margin-top: 0px;margin-bottom: 0px;">
							<span class="splited-line"><span class="splited-line__wrapper" >
								<ul style="font-family: 'Proxima Nova';text-decoration: none;list-style: none; ">
									<li style="width: 45%" class="linear-wipe myeveswing"><a href="ew/technical.html"> <i class="fas fa-cube" style="font-size:1.2em;"></i>   Technical Events</a></li>
